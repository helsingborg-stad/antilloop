...
import ParticlesIcon from "./ParticlesIcon";
...
const Particles: FC<ParticlesProps> = ({
  ...
  return (
    <div className={cn(variants({ variant }))}>
      <ParticlesIcon variant={settings.iconVariant} className="shrink-0" />
      <div>
        {!quickLink && (
          <IconButton
            ...
            a11y={t("a11y.buttons.particles_100_info")}
          />
        )}
        <p
          className={
        ...
        >
          {t(`particles.${quickLink ? "100_quick_link" : "100_title"}`)}
        </p>
        {(settings.currentLevel || settings.currentLevel === 0) && (
          <>
            ...
            >
              ...
              {t("particles.unit")} - {settings.degVariant}
            </p>
            {!quickLink && (
