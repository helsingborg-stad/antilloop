...
const CO2Chart = memo(({ data, size, xRange, rangeUpdated }: BarChartProps) => {
  ...
  const colorStops = [
    ...
    { color: "#FF492C", percent: 35 },
    { color: "#F6D138", percent: 50 },
    { color: "#64DD41", percent: 70 },
